  ...
  return (
    <ScreenLayout>
      <Container showsVerticalScrollIndicator={false}>
        ...
        <Text>
          약관은 Vina Arba모든 회원 활동에 적용됩니다. Vina Arba를 이용하면 본
          약관에 동의하는 것으로 간주합니다.
        </Text>
        <Title>제1장 총칙</Title>
        <SubTitle>제1조 (목적)</SubTitle>
        <Text>
          1. Vina Arba서비스 약관(이하 "본 약관")은 Vina Arba(이하 "Vina
          Arba")이 제공하는 Vina Arba및 Vina Arba관련 모든 서비스와 관련하여
          Vina Arba와 회원의 권리⋅의무 및 책임사항, 기타 필요한 사항을 규정함을
          목적으로 합니다.
        </Text>
        ...
        <Text>
          ...
          포함)와 상관없이 "이용자"가 Vina Arba플랫폼에 접속하여 Vina Arba및
          Vina Arba가 제공하는 일체의 용역. 자료 DB화, 컴퓨터 기타 이와 유사한
          정보통신처리장치를 이용한 일체의 행위를 말합니다.
        </Text>
        <Text>
          b. 이용자: Vina Arba에 접속하여 본 약관에 따라 서비스를 받는 모든 회원
        </Text>
        <Text>
          c. 회원: Vina Arba에 개인정보를 제공하여 회원등록을 한 자로서, Vina
          Arba의 정보를 제공받으며, 서비스를 이용할 수 있는 사람을 말합니다.
        </Text>
        <Text>
          d. 비회원: 회원에 가입하지 않고 Vina Arba가 제공하는 서비스를 이용하는
          자를 말합니다.
        </Text>
        <Text>
          e. 회원ID: 회원 식별과 서비스 이용을 위하여 Vina Arba회원임을 확인하고
          회원 자신의 비밀보호를 위해 회원 자신이 선정하고 Vina Arba가 승인하는
          이메일 주소
        </Text>
        <Text>
          f. 비밀번호: Vina Arba회원이 부여받은 회원ID와 일치된 회원임을
        ...
        <Text>
          h. 유료서비스: Vina Arba가 유료로 제공하는 각종 콘텐츠 및 제반 서비스
        </Text>
        <Text>
          i. 서비스이용요금(또는 서비스요금 또는 이용요금): Vina Arba가 제공하는
          서비스를 사용하기 위해서 지불하는 대가
        </Text>
        <Text>
          j. 플랫폼: Vina Arba가 서비스를 제공하기 위해 온라인에 구축한
        ...
        <Text>
          k. 어플리케이션: 플랫폼에 접속하여 Vina Arba가 제공하는 서비스를
          이용할 수 있도록 하는 웹, 모바일 웹, 스마트폰 앱, 기타 이와 유사한
          정보통신 처리장치
        </Text>
        <Text>
          l. 콘텐츠: Vina Arba가 생성, 수집, 기타 일체의 방법으로 플랫폼에
          제공한 콘텐츠
        </Text>
        <Text>
        ...
        <Text>
          n. 데이터: Vina Arba가 서비스를 제공하는 과정에서 수집하고 축적한 각종
          정보, 자료 및 이용의 콘텐츠
        </Text>
        <SubTitle>제3조 (약관적용과 약관 외 준칙)</SubTitle>
        <Text>
          1. Vina Arba의 서비스 이용에 관하여 본 약관을 적용하며, 본 약관에
        ...
        <Text>
          2. 약관의 내용은 서비스 약관 페이지에 게시하여 공지합니다. Vina Arba는
        ...
        <Text>
          3. Vina Arba의 약관을 개정할 경우 그 개정 약관은 적용일자 이후에
          체결되는 계약에만 적용됩니다. Vina Arba가 전항에 따라 회원에게
          ...
          특별한 사정이 있는 경우에는 Vina Arba는 이용계약을 해지할 수 있습니다.
        </Text>
        <Text>
        ...
        <Text>
          1. Vina Arba회원으로 가입하여 Vina Arba가 제공하는 서비스를 받고자
          하는 자는 회원가입절차를 거쳐 가입하여야 합니다. 회원 가입은 약관에
          동의하는 것으로 간주합니다. 약관 변경 시에는, 공지된 변경 약관에
          동의하지 않을 경우 고객지원센터 문의하시면 회원등록 취소가 가능합니다.
        </Text>
        <Text>
          2. Vina Arba는 "회원"에 대해 등급별로 구분하여 이용시간, 이용횟수,
          서비스 메뉴 등을 세분하여 이용에 차등을 둘 수 있습니다.
        </Text>
        <Text>
          3. Vina Arba는 전문기관을 통한 실명확인 및 본인인증을 요청할 수
          있습니다.
        </Text>
        <SubTitle>제6조 (이용신청)</SubTitle>
        <Text>
          1. 회원으로 가입하여 서비스를 이용하기를 희망하는 자는 Vina Arba가
        ...
        <Text>d. 기타 Vina Arba가 정한 이용 신청 요건이 미흡한 경우</Text>
        <Text>
          Vina Arba는 관계 법령에서 규정하는 미성년자일 경우에 서비스별 안내에서
        ...
        <Text>
          Vina Arba는 회원의 개인정보 보호를 위해 최선을 다하고 있습니다. 회원의
          개인정보 보호 및 회원이 Vina Arba를 이용하여 회원의 콘텐츠를 타인과
          공유하고 Vina Arba가 이를 수집 및 이용하는 방법에 대해 중요한 사항은
        ...
        <Text>
          ...
          전자우편으로 Vina Arba에 그 변경사항을 알려야 합니다. 회원정보의
          변경의 미통보로 인하여 발생한 손해의 책임은 회원에게 있습니다.
        </Text>
        ...
        <SubTitle>제13조 (Vina Arba의 의무)</SubTitle>
        <Text>
          1. Vina Arba는 본 약관에서 정한 바에 따라 계속적이고 안정적인 서비스의
          제공을 위하여 지속적으로 노력하며, 설비에 장애가 생기거나 멸실 된
          때에는 지체 없이 이를 수리 복구합니다. 다만, 천재지변, 비상사태 또는
          그밖에 부득이한 경우에는 그 서비스를 일시 중단하거나 중지할 수 있으며,
          이 경우에 대한 손해에 대해서는 Vina Arba가 책임지지 않습니다. 또한,
        ...
        <Text>
          3. Vina Arba는 회원으로부터 소정의 절차에 의해 제기되는 의견이나
          불만이 정당하다고 인정할 경우에는 적절한 절차를 거처 처리합니다. 처리
          시 일정 기간이 소요될 경우 회원에게 게시판, 전자우편, 기타 수단 등을
          이용하여 그 사유와 처리 일정을 알려드립니다.
        </Text>
        <Text>
          4. Vina Arba는 이용계약의 체결, 계약사항의 변경 및 해지 등
          이용고객과의 계약 관련 절차 및 내용 등에 있어 이용고객에게 편의를
          제공하도록 노력합니다.
        </Text>
        <Text>
          5. Vina Arba는 정보통신망 이용촉진 등에 관한 법률, 통신비밀보호법,
          전기통신기본법 등 서비스의 운영, 유지와 관련 있는 법규를 준수합니다.
        </Text>
        <SubTitle>제14조 (회원의 의무)</SubTitle>
        <Text>
          1. 유료 서비스를 사용하는 Vina Arba회원은 서비스 이용에 대한 대가로
          Vina Arba가 책정한 서비스 요금 등을 Vina Arba에 지불하여야 합니다.
          유료서비스 이용에 따른 요금 지급 등은 Vina Arba유료서비스 이용 및
          결제약관이 적용됩니다.
        </Text>
        <Text>
          2. 회원은 이 약관에서 규정하는 사항과 서비스 이용안내 또는 주의사항 등
          Vina Arba가 공지 혹은 통지하는 사항을 준수하여야 하며, 기타 Vina Arba
          운영에 방해되는 행위를 하여서는 안 됩니다. 본 약관의 규정이나 정신을
          위반하거나 Vina Arba에 위험이나 법적 피해를 초래한다면 Vina Arba서비스
        ...
        <Text>
          ...
          모든 불이익에 대한 책임을 부담합니다. 단, 이것이 Vina Arba의
          고의⋅과실로 인하여 야기된 경우는 Vina Arba가 책임을 부담합니다. Vina
          Arba은 다음 각호의 경우 해당 아이디의 이용을 제한할 수 있습니다.
        </Text>
        <Text>a. 개인정보 유출 우려가 있는 경우</Text>
        <Text>b. 반사회적 또는 미풍양속에 어긋나는 경우</Text>
        <Text>
          4. 회원은 내용 별로 Vina Arba가 서비스 공지사항에 게시하거나 전자우편
          등 별도로 공지한 이용제한 사항을 준수하여야 합니다.
        </Text>
        <Text>
          5. 회원은 Vina Arba의 명시적인 동의가 없는 한 서비스의 이용권한, 기타
          이용계약 상 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할
          수 없습니다.
        </Text>
        <Text>
          6. Vina Arba는 안전하게 유지하기 위해 최선을 다하고 있지만 회원이 다음
        ...
        <Text>
          b. 본 서비스를 통하여 얻은 정보를 Vina Arba의 사전 승낙 없이 회원의
        ...
        <Text>
          f. Vina Arba가 제공하는 서비스를 이용하여 불법적이거나 오해의 소지가
        ...
        <Text>
          i. Vina Arba의 허가없이 자동화된 수단(예, 수집로봇, 스파이더,
        ...
        <Text>
          ...
          스팸메일을 전송하는 등의 방법으로 Vina Arba의 서비스를 이용하여
          영리목적의 활동을 하는 행위
        </Text>
        <Text>
        ...
        <Text>
          m. Vina Arba의 사전 서면 동의 없이 경연이나 경품 등(이하 "프로모션"라
          함)을 Vina Arba서비스 내에서 제공하는 행위. Vina Arba가 동의하는
          경우에도 홍보에 대한 책임은 전적으로 회원에게 있으며, Vina Arba의
          프로모션가이드라인 및 관련 법규를 모두 준수해야 합니다.
        </Text>
        <Text>
          n. Vina Arba의 직원이나 관리자를 가장하거나 사칭하여 내용물을 게시,
          등록, 변경하거나 메일을 발송하는 행위
        </Text>
        <Text>o. 범죄와 결부된다고 객관적으로 판단되는 행위</Text>
        <Text>
          p. Vina Arba의 승인을 받지 않고 다른 사용자의 개인정보를 수집 또는
          저장하는 행위
        </Text>
        <Text>q. 본 약관의 위반을 조장하거나 권장하는 행위</Text>
        <Text>r. 기타 관계 법령에 위배되는 행위</Text>
        <Text>
          7. Vina Arba및 회원은 타인의 권리를 보호하기 위해 다음 각호에서 정한
          사항을 이행합니다.
        </Text>
        <Text>
          a. Vina Arba는 타인의 권리를 존중하며, 회원도 이를 존중해야 합니다.
        </Text>
        <Text>
          b. 회원은 타인의 권리를 침해하여서는 아니되며 법률을 위반하는 콘텐츠를
          게시하거나 그러한 조치를 취할 수 없습니다. 이에 위반하는 콘텐츠나
          정보를 Vina Arba가 임의로 제거할 수 있습니다.
        </Text>
        <Text>
        ...
        <Text>
          d. Vina Arba의 서면 허가 없이 Vina Arba의 저작권이나 상표권 및 Vina
          Arba과 혼동되는 유사 상표를 사용할 수 없습니다.
        </Text>
        <Text>
          e. 사용자로부터 정보를 수집하는 경우에는 사용자의 동의를 구하고 정보를
          수집하는 주체는 회원(Vina Arba가 아니라)임을 분명히 밝히고 회원이
        ...
        <Text>
          8. Vina Arba의 모바일 서비스는 다음 각호에서 정한 바에 따라
          제공됩니다.
        </Text>
        <Text>
          a. 회원은 Vina Arba에 보이는 기본 정보 및 사용자 콘텐츠를
        ...
        <Text>
          1. 이용자는 Vina Arba의 자체 서비스 및 공지내용을 이메일, 휴대폰
        ...
        <Text>
          1. Vina Arba의 각 게시판에 이용자가 글을 작성할 경우 글쓴이의 IP는
          비공개를 원칙으로 합니다. 또한, Vina Arba는 회원이 게시하거나 등록하는
        ...
        <Text>
          d. Vina Arba및 다른 회원 혹은 제3자의 저작권을 포함한 지식재산권 등
          기타 권리를 침해하는 내용인 경우
        </Text>
        <Text>
        ...
        <Text>
          Vina Arba는 건전한 통신문화정착과 효율적인 서비스 운영을 위하여
          이용자가 게시하거나 제공하는 자료가 다음에 해당한다고 판단되는 경우에
          임의로 삭제, 적합한 위치로의 자료이동, 등록거부를 할 수 있습니다.
        </Text>
        <Text>a. Vina Arba에서 규정한 게시 기간을 초과한 경우</Text>
        <Text>b. 게시판의 성격에 부합하지 않는 게시물의 경우</Text>
        <Text>
          c. 제3자 또는 Vina Arba의 명예, 신용을 훼손하거나 오용하는 내용 또는
          영업을 방해하는 내용인 경우
        </Text>
        <Text>d. 범죄적 행위와 결부된다고 객관적으로 인정되는 내용인 경우</Text>
        <Text>
          e. 제3자 또는 Vina Arba의 지식재산권 등 권리를 침해하는 내용인 경우
        </Text>
        <Text>f. 제16조에 해당하는 경우</Text>
        <Text>
          g. "정보통신망법" 및 "저작권법" 등 관계 법령 및 Vina Arba의 게시물
          관리 규정에 위배된다고 판단되는 경우
        </Text>
        <Text>
          ...
          소명하여 Vina Arba에 해당 게시물 등의 삭제 또는 반박 내용의 게재를
          요청할 수 있습니다. 이 경우 Vina Arba는 해당 게시물 등의 권리 침해
        ...
        <Text>
          ...
          합니다.)은 임시조치기간 중 Vina Arba에 해당 게시물 등을 복원해 줄 것을
          요청(이하 "재게시 청구"라 합니다.)할 수 있으며, Vina Arba는 임시조치된
          게시물의 명예훼손 등 판단에 대한 방송통신심의위원회 심의 요청에 대한
          게시자 및 삭제 등 신청인의 동의가 있는 경우 게시자 및 삭제 등 신청인을
          대리하여 이를 요청하고 동의가 없는 경우 Vina Arba가 이를 판단하여
          게시물 등의 복원 여부를 결정합니다. 게시자의 재게시 청구가 있는 경우
          임시조치 기간 내에 방송통신심의위원회 또는 Vina Arba의 결정이 있으면
          그 결정에 따르고 그 결정이 임시조치 기간 내에 있지 않는 경우 해당
          게시물 등은 임시조치 만료일 이후 복원됩니다. 재게시 청구가 없는 경우
          해당 게시물 등은 임시조치 기간 만료 이후 삭제됩니다.
        </Text>
        <Text>
          4. Vina Arba는 서비스 내에 게시된 게시물 등이 사생활 침해 또는
          명예훼손 등 제3자의 권리를 침해한다고 인정하는 경우 제2항에 따른 회원
          또는 제3자의 신고가 없는 경우에도 임시조치(이하 "임의의 임시조치"라
          합니다.)를 취할 수 있습니다. 임의의 임시조치된 게시물의 처리 절차는
          제2항 후단 및 제3항의 규정에 따릅니다.
        </Text>
        <Text>
          5. 회원의 게시물 등으로 인한 법률상 이익 침해를 근거로, 다른 회원 또는
          제3자가 회원 또는 Vina Arba를 대상으로 하여 민형사상의 법적 조치(예:
          형사고소, 가처분 신청·손해배상청구 등 민사소송의 제기)를 취하는 경우,
          Vina Arba는 동 법적 조치의 결과인 법원의 확정판결이 있을 때까지 관련
        ...
        <Text>
          a. Vina Arba가 작성한 저작물에 대한 저작권 기타 지식재산권은 Vina
          Arba에 귀속합니다. 단, "회원"의 "게시물" 및 제휴계약에 따라 제공된
          저작물 등은 제외합니다.
        </Text>
        <Text>
          b. "Vina Arba"는 서비스와 관련하여 "회원"에게 "Vina Arba"이 정한
          이용조건에 따라 계정, "아이디", 콘텐츠, 등을 이용할 수 있는 이용권만을
          부여하며, 회원은 서비스를 이용함으로써 얻은 정보를 Vina Arba의 사전
        ...
        <Text>
          ...
          정한 바에 따라 Vina Arba에게 사용권한을 부여합니다. 회원은 Vina Arba에
          대한 사용권한 부여를 회원의 개인 정보 설정 및 어플리케이션 설정에서
          결정할 수 있습니다.
        </Text>
        <Text>
          i. 회원은 회원의 사용자 콘텐츠를 서비스 개선 목적으로 분석할 수 있는
          권한을 Vina Arba에게 부여합니다. 단, Vina Arba에 부여된 권한은 전
          세계를 대상으로 하며, 비독점적이고, 양도 또는 재면허를 부여할 수 있고,
          그에 대한 사용료, 기타 반대급부는 무상으로 합니다.
        </Text>
        <Text>
          ii. 회원이 Vina Arba에 부여한 권한은 회원이 회원의 사용자 콘텐츠나
          계정을 삭제할 때 종료됩니다. 단, 회원이 콘텐츠를 타인과 공유하고
          타인이 이를 삭제하지 않았을 경우에는 그러하지 아니합니다. 외부 API등
          오픈플랫폼을 제공하는 서비스에 저장되는 경우 콘텐츠 유실 등의 책임은
          Vina Arba가 부담하지 않습니다.
        </Text>
        <Text>
        ...
        <Text>
          e. Vina Arba에 대한 의견을 포함한 제안은 언제든지 환영하지만,
          (회원에게 제안 의무가 없는 것처럼) Vina Arba도 보상 의무 없이 이를
          활용할 수 있습니다.
        </Text>
        <Text>
          f. Vina Arba는 제10조 이외의 방법으로 회원의 사용자 콘텐츠를
          상업적으로 이용하고자 하는 경우, 전화, 팩스, 전자우편 등의 방법을 통해
          사전에 회원의 동의를 얻어야 합니다. 단, 회원정보에 등록된 연락처가
          사실과 다르거나 회원이 Vina Arba의 연락에 응하지 않아 사전에 동의를
          구하지 못한 경우, Vina Arba는 사후에 동의 절차를 구할 수 있습니다.
          Vina Arba가 본 호에 따라 회원의 사용자 콘텐츠를 상업적으로 이용할 경우
          Vina Arba는 별도의 보상제도를 운영할 수 있습니다.
        </Text>
        <SubTitle>제19조 (광고게재 및 광고주와의 거래)</SubTitle>
        <Text>
          1. Vina Arba는 본 서비스 상에 게재된 광고주의 판촉활동 및 광고주와
          회원간의 교신 또는 거래의 결과로서 발생하는 모든 손실 또는 손해에 대해
          책임을 지지 않습니다.
        </Text>
        <SubTitle>제20조 (서비스 이용시간)</SubTitle>
        <Text>
          1. 서비스의 이용은 Vina Arba의 업무상 또는 기술상 특별한 지장이 없는
          한, 연중무휴, 1일 24시간 가능함을 원칙으로 합니다. 다만, 정기 점검
          등의 필요로 Vina Arba가 정한 기간은 예외입니다.
        </Text>
        <Text>
          2. Vina Arba는 서비스를 일정범위로 분할하여 각 범위 별로 이용가능
          시간을 별도로 정할 수 있습니다. 이 경우 사전에 공지를 통해 그 내용을
          알립니다.
        </Text>
        <SubTitle>제21조 (서비스 제공의 중지 등)</SubTitle>
        <Text>
          1. Vina Arba는 다음에 해당하는 경우 서비스 제공을 중지할 수 있습니다.
        </Text>
        <Text>
        ...
        <Text>
          2. Vina Arba는 국가비상사태, 정전, 서비스 설비의 장애 또는 서비스
          이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 때에는 서비스의
          전부 또는 일부를 제한하거나 중지할 수 있습니다.
        </Text>
        <Text>
          3. Vina Arba는 제1항 및 제2항의 규정에 의하여 서비스의 이용을
          제한하거나 중지한 때에는 그 사유 및 제한기간 등을 Vina Arba를 통하여
        ...
        <Text>
          ...
          Vina Arba는 관련법 등이 정하는 바에 따라 이를 즉시 처리합니다.
        </Text>
        <Text>
        ...
        <Text>
          4. Vina Arba는 회원이 본 약관 제14조의 의무를 위반하거나, 기타 본
        ...
        <Text>
          ...
          없는 경우에는 Vina Arba의 서비스 제공에 관한 책임이 면제됩니다.
        </Text>
        <Text>
          2. Vina Arba는 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여
          책임을 지지 않습니다.
        </Text>
        <Text>
          3. Vina Arba는 회원이 서비스를 이용하여 기대하는 수익을 상실한 것이나
          서비스를 통하여 얻은 자료로 인한 손해에 관하여 책임을 지지 않습니다.
        </Text>
        <Text>
          4. Vina Arba는 제휴회사가 제공하거나 회원이 서비스에 게재한 정보, 자료
          등의 사실 유무 신뢰도, 정확성 등에 관하여는 책임을 지지 않습니다.
        </Text>
        <Text>
          5. Vina Arba는 서비스 이용과 관련하여 가입자에게 발생한 손해 가운데
          가입자의 고의, 과실에 의한 손해에 대하여 책임을 지지 않습니다.
        </Text>
        <SubTitle>제24조 (이용자 보호)</SubTitle>
        <Text>
          1. Vina Arba는 서비스 이용약관을 공시하여 이용자의 피해를 최소화하기
          위해 노력합니다.
        </Text>
        <SubTitle>제25조 (분쟁 해결)</SubTitle>
        <Text>
          1. Vina Arba는 이용자로부터 제기되는 불만사항 및 의견을 우선적으로
          처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와
          처리 일정을 즉시 통보합니다.
        </Text>
        <Text>
          2. Vina Arba와 회원은 서비스와 관련하여 발생한 분쟁을 원만하게
          해결하기 위하여 필요한 모든 노력을 합니다.
        </Text>
        <Text>
          3. 회원의 Vina Arba에서의 활동이나 콘텐츠, 정보와 관련하여 타인이 Vina
          Arba를 상대로 클레임을 제기하면, 회원은 해당 클레임과 관련된 손해나
          손실, 경비(합리적인 변호사 수임료와 비용 포함)로부터 Vina Arba를 면책
          및 보호해야 합니다.
        </Text>
        <Text>
          4. Vina Arba는 제3자의 활동, 콘텐츠, 정보, 데이터에 대해 책임지지
          않으며, 인지 여부에 관계 없이 해당 제3자를 상대로 제기하는 클레임으로
          인하거나 그와 관련하여 발생하는 클레임과 손해로부터 Vina Arba와 Vina
          Arba의 이사, 임직원을 면책합니다. 본 조항이나 Vina Arba에 의해
          발생하는 채무 총액은 지난 일년간 Vina Arba에 납부한 금액을 초과할 수
          없습니다.
        </Text>
        <Text>
