...
- [] expo 46 으로 업그레이드 (사진 여러장 업로드 가능 - 안드로이드전체,, ios는 14버전이상가능), 그리고 사진 업로드할때 edit 못하게 하고 강제로 내가 가로 세로 지정할 거임 (바로 아래 내용 참고) 사진 용량 적게, 최적화 시키기위해 / splash 화면 만드는법 즐겨찾기 확인
- [] 사진 업로드시 사진 비율 내가 지정 (인스타 참고) / 가로 얼마 세로 얼마 이상은 강제로 얼마로, 얼마 이하는 강제로 얼마로
- [] 사진 여러장 동시에 올릴 때, 각 사진 별 로딩되게끔 세팅 (x 누르면 삭제 로직) - 당근마켓 참조
